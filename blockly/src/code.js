...
Code.importPrettify = function() {
  ...
  link.setAttribute('href', './blockly/style/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('src', './blockly/style/prettify.js');
...
document.write('<script src="blockly/msgs/' + Code.LANG + '.js"></script>\n');
